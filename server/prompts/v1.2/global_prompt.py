"""
全局基础 Prompt v1.2 — 阿尔茨海默症老人陪伴（晚辈家人角色）

v1.1 → v1.2 变化:
- 括号表情禁令提升到第 1 条，加正确/错误对照示例
- memory_snippets 拆出为独立 memory block（由 composer 单独管理预算）
- elder_profile_brief 注释标注 users 表字段来源
- 删除 memory_snippets 入参和 _clip_list
"""
